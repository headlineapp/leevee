...
project_id = 'silken-acronym-137923'
model_id = 'language-identifier'
...
def make_prediction():
    ...
    prediction = api.trainedmodels().predict(project=project_id, id=model_id, body={
        'input': {
            'csvInstance': ['Hi, my name is Feizal',]
        },
    }).execute()
...
def train_model():
    ...
    api.trainedmodels().insert(project=project_id, body={
        'id': model_id,
        'storageDataLocation': 'silken-acronym-137923.appspot.com/language_id.txt',
